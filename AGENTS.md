...
This file is the quick-reference operating contract for shlex-kotlin. The longer
...
shlex-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`shlex`](https://crates.io/crates/shlex). Upstream Rust is the behavioral oracle while the
