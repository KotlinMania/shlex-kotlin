...
kotlin {
    ...
    val xcf = XCFramework("Shlex")

    macosArm64 {
        binaries.framework { baseName = "Shlex"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Shlex"
    ...
    swiftExport {
        moduleName = "Shlex"
        flattenPackage = "io.github.kotlinmania.shlex"
    }

    android {
        namespace = "io.github.kotlinmania.shlex"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "shlex-kotlin", version.toString())

    pom {
        name.set("shlex-kotlin")
        description.set("Kotlin Multiplatform port of comex/rust-shlex - Split a string into shell words, like Python's shlex")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/shlex-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/shlex-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/shlex-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/shlex-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/shlex/CodeqlEmptySentinel.kt")
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleShlexXCFramework",
    "assembleShlexDebugXCFramework",
    "assembleShlexReleaseXCFramework",
    "assembleDebugIosFatFrameworkForShlexXCFramework",
    "assembleReleaseIosFatFrameworkForShlexXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForShlexXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForShlexXCFramework",
    "assembleDebugMacosFatFrameworkForShlexXCFramework",
    "assembleReleaseMacosFatFrameworkForShlexXCFramework",
    "assembleDebugTvosFatFrameworkForShlexXCFramework",
    "assembleReleaseTvosFatFrameworkForShlexXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForShlexXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForShlexXCFramework",
    "assembleDebugWatchosFatFrameworkForShlexXCFramework",
    "assembleReleaseWatchosFatFrameworkForShlexXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForShlexXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForShlexXCFramework",
