...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Shlex.swiftmodule/`
...
//      `import Shlex` above would fail at compile time.
//
//   2. The static archive `libShlex.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Shlex" }` and
//      `flattenPackage = "io.github.kotlinmania.shlex"` configuration in
...
final class ShlexExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Shlex swift module imported cleanly")
    }
}
